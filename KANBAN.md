...
|-------|------------|--------|------------------------------------------------|---------------------------------------------------------------------------------------------------------|------------|------------|-------------|------------|
| 01.1  | ✅ Done | ET-01  | Baixar e organizar o dataset                   | Fazer download do dataset no Kaggle, criar a estrutura de pastas, organizar imagens e metadados na pasta `/data`. | DD/MM/2025 | DD/MM/2025 |      Francis       | Alta       |
| 01.2  | ✅ Done | ET-01  | Verificar integridade dos arquivos             | Validar se todas as imagens listadas nos metadados existem na pasta e vice-versa, garantindo consistência. | DD/MM/2025 | DD/MM/2025 |      Francis       | Alta       |
...
| 01.8  | 🔄 Backlog | ET-01  | Documentar análise do dataset                  | Documentar todos os passos da análise de dados (EDA) | DD/MM/2025 | DD/MM/2025 |   **TODOS**          | Alta       |
| 01.9  | 🔄 Backlog | ET-01  | Elaborar apresentação                  | Criar slides para apresentação da etapa. | DD/MM/2025 | DD/MM/2025 |             | Alta       |
